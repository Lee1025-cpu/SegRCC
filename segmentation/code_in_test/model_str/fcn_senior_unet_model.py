...
class Abstract3DUNet(nn.Module):
    ...
    Args:
        ...
        f_maps (int, tuple): if int: number of feature maps in the first conv layer of the encoder (default: 4);
    ...
    def __init__(self, in_channels, out_channels, final_sigmoid, basic_module, f_maps=4, layer_order='gcr',
                 num_groups=8, num_levels=3, is_segmentation=True, testing=False,
...
class UNet3D(Abstract3DUNet):
    ...
    `"3D U-Net: Learning Dense Volumetric Segmentation from Sparse Annotation"
        <https://arxiv.org/pdf/806.06650.pdf>`.

    Uses `DoubleConv` as a basic_module and nearest neighbor upsampling in the decoder
    """

    def __init__(self, in_channels, out_channels, final_sigmoid=True, f_maps=4, layer_order='gcr',
                 num_groups=8, num_levels=3, is_segmentation=True, conv_padding=1, pool_kernel_size=2, **kwargs):
