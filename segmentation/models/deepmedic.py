...
class ResBlock(nn.Module):
    def __init__(self, inplanes, planes):
        ...
        self.conv1 = nn.Conv3d(inplanes, planes, 3, padding=1, bias=False)
...
def conv3x3(inplanes, planes, ksize=3, padding=1):
    return nn.Sequential(
            nn.Conv3d(inplanes, planes, ksize, padding=padding, bias=False),
